...
<form method="post" class="form-horizontal" action="save_penjualan.php">
<div class="container">
  <form action="/action_page.php">

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">ID User:</label>
    ...
    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">ID Penjualan:</label>
      <div class="col-sm-4 control-label">
      <input type="text" class="form-control" id="usr" name="id_penjualan">
    </div>
    </div>  

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Jumlah:</label>
      <div class="col-sm-4 control-label">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Total Harga:</label>
      <div class="col-sm-4 control-label">
      <input type="text" class="form-control" id="usr" name="total_harga">
    </div>
    </div> 

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Tgl Penjualan:</label>
      <div class="col-sm-4 control-label">
      <input type="date" class="form-control" id="usr" name="tgl_penjualan">
    </div>
    </div>
