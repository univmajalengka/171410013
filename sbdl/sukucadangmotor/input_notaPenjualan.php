...
<form method="post" class="form-horizontal" action="save_notapenjualan.php">
<div class="container">
  <form action="/action_page.php">
    ...
    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Tanggal Beli:</label>
      <div class="col-sm-4 control-label">
      <input type="date" class="form-control" id="usr" name="tgl_beli">
    </div>
    </div> 
...
<hr>
<?php 
include 'view_notapenjualan.php';
?>
<hr>
