...
<h3 align="center">Detail Stok Barang</h3>
...
<?php
    $no=1;
    $query=("SELECT * FROM laporanstokbarang WHERE tgl_laporan='$_GET[id]'");
...
<a href="input_laporanstokbarang.php?halaman=user" class="btn btn-sm btn-primary">Kembali</a>