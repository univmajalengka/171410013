...
<form method="post" class="form-horizontal" action="save_laporan.php">
<div class="container">
  <form action="/action_page.php">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Jenis Laporan:</label>
      <div class="col-sm-4 control-label">
      <input type="text" class="form-control" id="usr" name="jenis_laporan">
    </div>
    </div> 

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Tgl Laporan:</label>
      <div class="col-sm-4 control-label">
      <input type="date" class="form-control" id="usr" name="tgl_laporan">
    </div>
    </div>
