...
<div class="container">
  <form action="/action_page.php">
    ...
    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Hak Akses:</label>
      <div class="col-sm-4 control-label">
      <input type="text" class="form-control" id="usr" name="hak_akses">
    </div>
    </div> 

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Username:</label>
      <div class="col-sm-4 control-label">
     ...
     <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Password:</label>
      <div class="col-sm-4 control-label">
