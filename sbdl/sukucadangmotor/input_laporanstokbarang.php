...
<form method="post" class="form-horizontal" action="save_laporanstokbarang.php">
<div class="container">
  <form action="/action_page.php">

    <div class="form-group">
      <label for="usr" class="col-sm-3 control-label">Tgl Laporan Stok Barang:</label>
...
<hr>
<?php 
include 'view_laporanstokbarang.php';
?>
<hr>
